% clear all;
close all;
 fprintf("Starting test: SMOOTH DENSITY. \n");
 fprintf("-----------------------------------------\n\n");
...
%Naming
method = 'price';
place = "data/models/smooth/";
test_name = place + "test_smooth_rho_1000_models";
...
if simulate1
    ...
    if save_work
    save(test_name+"_rcx_eq_"+Rcx_text(1)+"_hme","time_hme1","time_hme_ave1",'x','Rcx','T_ave','M','CFL','T','theta_p','u_p','dt','dx','mom_hme_ave1','rho_hme_ave1','energy_hme_ave1');
    end
    end
    if sim_qbme
    tic;
    ...
    if save_work
    save(test_name+"_rcx_eq_"+Rcx_text(1)+"_qbme","time_qbme1","time_qbme_ave1",'x','Rcx','T_ave','M','CFL','T','theta_p','u_p','dt','dx','mom_qbme_ave1','rho_qbme_ave1','energy_qbme_ave1');
    end
    end
    if sim_lin
    tic;
    ...
    if save_work
    save(test_name+"_rcx_eq_"+Rcx_text(1)+"_lin",'time_lin1','time_lin_ave1','x','Rcx','T_ave','M','CFL','T','theta_p','u_p','dt','dx','mom_lin_ave1','rho_lin_ave1','energy_lin_ave1');
    end
    end
end
% 
if simulate2
    ...
    if save_work
    save(test_name+"_rcx_eq_"+Rcx_text(2)+"_hme","time_hme2","time_hme_ave2",'x','Rcx','T_ave','M','CFL','T','theta_p','u_p','dt','dx','mom_hme_ave2','rho_hme_ave2','energy_hme_ave2');
    end
    end
    if sim_qbme
    ...
    if save_work
    save(test_name+"_rcx_eq_"+Rcx_text(2)+"_qbme","time_qbme2","time_qbme_ave2",'x','Rcx','T_ave','M','CFL','T','theta_p','u_p','dt','dx','mom_qbme_ave2','rho_qbme_ave2','energy_qbme_ave2');
    end
    end
    if sim_lin
    tic;
    ...
    if save_work
    save(test_name+"_rcx_eq_"+Rcx_text(2)+"_lin",'time_lin2','time_lin_ave2','x','Rcx','T_ave','M','CFL','T','theta_p','u_p','dt','dx','mom_lin_ave2','rho_lin_ave2','energy_lin_ave2');
    end
    end
end
if simulate3
    ...
    if save_work
    save(test_name+"_rcx_eq_"+Rcx_text(3)+"_hme","time_hme3","time_hme_ave3",'x','Rcx','T_ave','M','CFL','T','theta_p','u_p','dt','dx','mom_hme_ave3','rho_hme_ave3','energy_hme_ave3');
    end
    end
    ...
    if save_work
    save(test_name+"_rcx_eq_"+Rcx_text(3)+"_qbme","time_qbme3","time_qbme_ave3",'x','Rcx','T_ave','M','CFL','T','theta_p','u_p','dt','dx','mom_qbme_ave3','rho_qbme_ave3','energy_qbme_ave3');
    end
    end
    if sim_lin
    tic;
    ...
    if save_work
    save(test_name+"_rcx_eq_"+Rcx_text(3)+"_lin",'time_lin3','time_lin_ave3','x','Rcx','T_ave','M','CFL','T','theta_p','u_p','dt','dx','mom_lin_ave3','rho_lin_ave3','energy_lin_ave3');
    end
    end
end
...
if simulate4
    ...
    if save_work
    save(test_name+"_rcx_eq_"+Rcx_text(4)+"_hme","time_hme4","time_hme_ave4",'x','Rcx','T_ave','M','CFL','T','theta_p','u_p','dt','dx','mom_hme_ave4','rho_hme_ave4','energy_hme_ave4');
    end
    end
    if sim_qbme
    tic;
    ...
    if save_work
    save(test_name+"_rcx_eq_"+Rcx_text(4)+"_qbme","time_qbme4","time_qbme_ave4",'x','Rcx','T_ave','M','CFL','T','theta_p','u_p','dt','dx','mom_qbme_ave4','rho_qbme_ave4','energy_qbme_ave4');
    end
    end
    if sim_lin
    tic;
    ...
    if save_work
    save(test_name+"_rcx_eq_"+Rcx_text(4)+"_lin",'time_lin4','time_lin_ave4','x','Rcx','T_ave','M','CFL','T','theta_p','u_p','dt','dx','mom_lin_ave4','rho_lin_ave4','energy_lin_ave4');
    end
    end
end
