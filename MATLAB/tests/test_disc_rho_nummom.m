...
% Experiments with same initial conditions but different number of moments M
% to see the accuracy of the  model for different.
%% PArameters
method = 'price';
place = "data/moments/disc/";
test_name = place + "test_weak_disc_rho_1000_mom_rcx_1e0_mom";
